...
__My read:__ Transportation directly consulted BFD even during the conceptual phase, and IIRC they added a mountable curb across much of the narrow segment of the street.
...
__My read:__ Javandel is talking about "requirements", that BFD has "rejected" and "vetoed", that Transportation need to "achieve consensus" and "negotiate" and find "a viable compromise". That sounds pretty professional and appropriate to me, and it does not sound like someone barreling ahead with no thought for the fire department.

### Fire Chief Says Process Is TBD

On Feburary 8, 2023, Fire Chief David Sprague explained in an email [following up on a meeting with local activists](https://hopkins-street-documents.s3.us-west-2.amazonaws.com/RE_%2BThanks_Redacted%20Redacted.pdf) that the city does not have an established process for how the fire department gives input on public works projects:
...
__My read:__ If they working on the V1 of a protocol for fire-public works collaboration less than two months before the project was canceled, supposedly on account of fire regulations, I can only infer that such a protocol didn't exist. It doesn't feel reasonable to accuse people of not following procedures that don't exist.
...
[^1]: These docs came from public records requests
