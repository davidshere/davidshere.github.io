...
This interactive calculator helps real estate developers analyze the feasibility of different development scenarios. 
Enter your target yield and configure the unit mix to see if your project meets your investment criteria.
